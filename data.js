...
const SESSION_KEY = {
  ...
  // Day 2 (3/26)
  "융복합I-메디컬II": "ConvMed2",
  "융복합I-메디컬II / 좌장: 정준수(부산대), 유성광(인제대)" : "ConvMed2",
  "물리I": "Phys1",
...
const APP_DATA = {
  days: [
    ...
    // =========================
    {
      ...
      speaker_affil: "전남대학교",speaker_name: "배주열 교수", pdf: "pdf/jubae.pdf"}] },
            { name: "튜토리얼 III", room: "201B", note: "", talks: [{kind: "", title: "저차원 나노미터 공간에서의 물질 전달 현상",
      speaker_affil: "포항공과대학교",speaker_name: "박형규 교수", pdf: "pdf/hyungpark.pdf"}] }
          ]
        },
        {
          time: "10:20~10:30",
    ...
    // =========================
    {
      ...
      timeBlocks: [
        {
          ...
          sessions: [
            ...
            { name: "융복합I-메디컬II / 좌장: 정준수(부산대), 유성광(인제대)", room: "영주홀A", note: "초청강연 1편, 일반 구두발표 3편", talks: [] }
          ]
        },
      ...
      speaker_affil: "삼성전자 미래기술육성센터", speaker_name: "조승희 PD", pdf: "pdf/Seungcho.pdf"}] } ] },
        ...
        { time: "15:00~15:15", sessions: [ { name: "휴식 및 이동", room: "로비", talks: [] } ] },
        {
          time: "15:15~16:25",
          sessions: [
        ...
        { time: "16:25~16:40", sessions: [ { name: "휴식 및 이동", room: "로비", talks: [] } ] },
        {
          time: "16:40~17:40",
          sessions: [
    ...
    // =========================
    {
      ...
      timeBlocks: [
        ...
        { time: "09:10~09:20", sessions: [ { name: "휴식 및 이동", room: "로비", talks: [] } ] },
        {
          time: "09:20~10:20",
          sessions: [
...
fillTalks("2026-03-26", "08:00~09:00", "융복합I-메디컬II / 좌장: 정준수(부산대), 유성광(인제대)", [
  { kind: "Invited", time: "08:00~08:24", title: "Pd-catalyzed SnO₂/ZnO Heterojunction Hydrogen Sensor Enabling Wide-range Detection via Hydrogen-Induced Metal-Like Conduction", speaker_affil: "부산대학교", speaker_name: "정대웅 교수" },
  { kind: "Oral",    time: "08:24~08:36", title: "비침습적 시간 간섭 기반의 선택적 뇌심부 자극을 위한 MEMS 기반 유연 전극 어레이와 임피던스 적응 형 폐루프 무선 시스템", speaker_affil: "고려대학교", speaker_name: "차지형" },
  { kind: "Oral",    time: "08:36~08:48", title: "빠른 포도당 검출을 위한 광 시냅틱 트랜지스터 기반 센서", speaker_affil: "서강대학교", speaker_name: "류승표" },
  { kind: "Oral",    time: "08:48~09:00", title: "만성 신경 질환 치료를 위한 장시간 구동 가능한 온도센서 집적된 소프트 마이크로유체 냉각 소자", speaker_affil: "부산대학교", speaker_name: "권효경" }
]);

// 08:00~08:56  물리I
fillTalks("2026-03-26", "08:00~09:00", "물리I / 좌장: 조은환(금오공대), 표순재(서울과기대)", [
  { kind: "Invited", time: "08:00~08:24", title: "Micro- and Nano-Devices for Tailoring Heat and Light", speaker_affil: "중앙대학교", speaker_name: "임미경 교수" },
  { kind: "Oral",    time: "08:24~08:36", title: "Dummy Trench 설계에 따른 SiC Trench MOSFET의 전계 재분포와 항복 특성 분석", speaker_affil: "전북대학교", speaker_name: "이동석" },
  { kind: "Oral",    time: "08:36~08:48", title: "F-Fe-MOF Functionalized PVDF-HFP Nanofibrous Mats-based Triboelectric Nanogenerator for Self-Powered Respiratory Rehabilitation Monitoring", speaker_affil: "광운대학교", speaker_name: "소피울" },
  { kind: "Oral",    time: "08:48~09:00", title: "Silicon Nanohelices for Chiral Plasmonic in Ultraviolet", speaker_affil: "광주과학기술원", speaker_name: "김주환" }
]);
...
fillTalks("2026-03-26", "11:15~12:25", "유체II / 좌장: 김원정(연세대), 전형국(서울과기대)", [
  ...
  { kind: "Oral",    time: "12:13~12:25", title: "Physical AI를 위한 투명 히터 기반의 능동형 자가세정 시스템", speaker_affil: "명지대학교", speaker_name: "김영광" }
]);
...
fillTalks("2026-03-26", "11:15~12:25", "물리II-소재, 가공, 패키징II / 좌장: 김회준(DGIST), 이한얼(GIST)", [
  ...
  { kind: "Oral",    time: "12:13~12:25", title: "Self-Powered Omnidirectional Pressure Sensing Smart Ball Sensor for Hand Rehabilitation Monitoring", speaker_affil: "광운대학교", speaker_name: "Shital Sharma" }
]);

// 13:50~14:58  바이오I
fillTalks("2026-03-26", "13:50~15:00", "바이오I / 좌장: 이현주(KAIST), 이대식(ETRI)", [
  { kind: "Invited", time: "13:50~14:12", title: "미세유체 기반 종양모사칩: 면역항암제 개발을 위한 차세대 플랫폼", speaker_affil: "경희대", speaker_name: "이소민 교수" },
  { kind: "Oral",    time: "14:12~14:24", title: "Optimization of Electrical Stimulation for Cardiomyocyte Maturation Based on Long-Term Wireless Monitoring", speaker_affil: "전남대학교", speaker_name: "유극" },
  { kind: "Oral",    time: "14:24~14:36", title: "양방향 신경 조절을 위한 마이크로 LED 집적 투명 표면 ECoG 센서 어레이", speaker_affil: "한국과학기술원", speaker_name: "리옹지아치" },
  { kind: "Oral",    time: "14:36~14:48", title: "Development of Wireless MEMS-Based Neural Probe System for Simultaneous Measurement of Electrical and Chemical Signals", speaker_affil: "고려대학교", speaker_name: "김근태" },
  { kind: "Oral",    time: "14:48~15:00", title: "MOF-Derived Transition-Metal Carbide@Polypyrrole Nanohybrids for a Highly Sensitive and Stretchable Multimodal Sweat-Sensing Patch", speaker_affil: "광운대학교", speaker_name: "자히둘 이슬람" }
]);

// 13:50~14:58  유연I
fillTalks("2026-03-26", "13:50~15:00", "유연I / 좌장: 박인규(KAIST), 안준성(고려대)", [
  { kind: "Invited", time: "13:50~14:12", title: "초고감도 금 도핑 실리콘 나노멤브레인 기반 온도 센서", speaker_affil: "가천대학교", speaker_name: "상민규 교수" },
  { kind: "Oral",    time: "14:12~14:24", title: "비침습적 다종 암 스크리닝을 위한 멀티모달 호기 패턴 기반 계층적 딥러닝 모델", speaker_affil: "한국전자통신연구원", speaker_name: "이병주" },
  { kind: "Oral",    time: "14:24~14:36", title: "Versatile Water-Floated Nanostructure for Three-Dimensional Nanotransfer Printing", speaker_affil: "한국과학기술원", speaker_name: "강병호" },
  { kind: "Oral",    time: "14:36~14:48", title: "인간수준 고밀도-고해상도 촉각센서 기반 적응형 시-촉각 융합 및 로봇 인지 기술", speaker_affil: "연세대학교", speaker_name: "박병선" },
  { kind: "Oral",    time: "14:48~15:00", title: "Sustainable Fiber-based Electronic Systems Enabled by Highly Conductive, Deformation-Invariant Biodegradable Fiber Electrodes", speaker_affil: "대구경북과학기술원", speaker_name: "김진호" }
]);

// 15:15~16:23  유체III
fillTalks("2026-03-26", "15:15~16:25", "유체III / 좌장: 이종완(군산대), 김민석(금오공대)", [
  { kind: "Invited", time: "15:15~15:37", title: "회전환 증폭을 응용한 혈액 종양 순환 DNA 및 마이크로 RNA의 민감 액체 생검 전략", speaker_affil: "금오공과대학교", speaker_name: "류준석 교수" },
  { kind: "Oral",    time: "15:37~15:49", title: "뉴턴 및 점탄성 유체 공동흐름을 이용한 박테리아 제거", speaker_affil: "전남대학교", speaker_name: "김현욱" },
  { kind: "Oral",    time: "15:49~16:01", title: "Wrinkle-Assisted Nanofluidic Memristors for Tunable Ionic Memory and Neuromorphic Learning", speaker_affil: "울산과학기술원", speaker_name: "권민수" },
  { kind: "Oral",    time: "16:01~16:13", title: "Low-Voltage Slippery Microbubble Manipulation Using Dual High-k and Lubricating Layers for Ultrasound Modulation", speaker_affil: "한국과학기술원", speaker_name: "김수빈" },
  { kind: "Oral",    time: "16:13~16:25", title: "In-situ Visualization of Surfactant-regulated Marangoni Flow during Polymer Membrane Formation at Immiscible Liquid-liquid Interface", speaker_affil: "한국과학기술원", speaker_name: "류준일" }
]);

// 15:15~16:23  소재, 가공, 패키징III
fillTalks("2026-03-26", "15:15~16:25", "소재, 가공, 패키징III / 좌장: 옥종걸(서울과기대), 이재홍(DGIST)", [
  { kind: "Invited", time: "15:15~15:37", title: "Human-Heat Interface and Its Applications in Wearable Technology", speaker_affil: "동국대학교", speaker_name: "이진우 교수" },
  { kind: "Oral",    time: "15:37~15:49", title: "Multilayer Sticker-type Anti-reflective Film for High-efficiency Optoelectronic Devices", speaker_affil: "서강대학교", speaker_name: "최지성" },
  { kind: "Oral",    time: "15:49~16:01", title: "Smart Glasses for Binocular Monitoring using High-speed Off-axis Microlens Array Camera", speaker_affil: "한국과학기술원", speaker_name: "권재명" },
  { kind: "Oral",    time: "16:01~16:13", title: "Mediator-free Ether Transfer of Discrete and Coalesced Silicon Nanostructures", speaker_affil: "한국과학기술원", speaker_name: "김태영" },
  { kind: "Oral",    time: "16:13~16:25", title: "이중 가교 전략을 통한 고하중 지지 및 가변 강성 기반의 재구성 가능한 자성 소프트 인공 근육", speaker_affil: "울산과학기술원", speaker_name: "권혁주" }
]);
...
// 08:00~09:08  바이오II
fillTalks("2026-03-27", "08:00~09:10", "바이오II / 좌장: 정현호(GIST), 이소민(경희대)", [
  { kind: "Invited", time: "08:00~08:22", title: "Wearable Mechanical Interfaces for Neural Interfaces and Digital Healthcare", speaker_affil: "한국과학기술원", speaker_name: "하경호 교수" },
  { kind: "Oral",    time: "08:22~08:34", title: "A V₂CTx-MXene@f-MWCNTs Epidermal Patch for Sweat Glucose and Ketone Monitoring", speaker_affil: "광운대학교", speaker_name: "조후룰 이슬람" },
  { kind: "Oral",    time: "08:34~08:46", title: "A Droplet-based Microfluidic Screening System for the Discovery of Slow-growing and Novel Microbes in Environmental Samples", speaker_affil: "광운대학교", speaker_name: "오별님" },
  { kind: "Oral",    time: "08:46~08:58", title: "A Through-Hole Cantilever Platform Integrated with Silicon Strain Sensors for Physiologically Relevant Double-Layer Cardiomyocytes Culture and Monitoring", speaker_affil: "전남대학교", speaker_name: "Fusong Li" },
  { kind: "Oral",    time: "08:58~09:10", title: "전혈 기반 NK세포 분리를 위한 미세유체 면역자기 플랫폼", speaker_affil: "고려대학교 세종캠퍼스", speaker_name: "한해희" }
]);

// 08:00~09:08  유체IV-유연II-화학III
fillTalks("2026-03-27", "08:00~09:10", "유체IV-유연II-화학III / 좌장: 하지환(한밭대), 이도환(광운대)", [
  { kind: "Invited", time: "08:00~08:22", title: "Light-Material Interaction Technologies for Wearable and Smart Electronic Systems", speaker_affil: "금오공과대학교", speaker_name: "박정환 교수" },
  { kind: "Oral",    time: "08:22~08:34", title: "미세 유동의 토출량 측정을 위한 MEMS 기반의 열량식 유량 센서 시스템", speaker_affil: "아주대학교", speaker_name: "이기용" },
  { kind: "Oral",    time: "08:34~08:46", title: "Analysis of Electroconvection near Ion-Selective Membranes in Non-Newtonian Fluids", speaker_affil: "서울대학교", speaker_name: "김동현" },
  { kind: "Oral",    time: "08:46~08:58", title: "전기화학 기반 나노플라스틱 검출 센서 개발", speaker_affil: "성균관대학교", speaker_name: "김치현" },
  { kind: "Oral",    time: "08:58~09:10", title: "웨어러블 촉각 디스플레이를 위한 강-연성 구조 기반 인장 둔감형 전기유체역학 액추에이터", speaker_affil: "연세대학교", speaker_name: "조승인" }
]);
